...
class Alumno(Usuario):
    def __init__(self, nombre, apellido, correo, padres):
        ...
        # super() > sirve para mandar a llamar a la clase de la cual estamos haciendo la herencia 
        # para no volver a escribir la misma logica, ademas solamente servira para poder 
        # acceder a los metodos de la clase de la cual estamos heredando
